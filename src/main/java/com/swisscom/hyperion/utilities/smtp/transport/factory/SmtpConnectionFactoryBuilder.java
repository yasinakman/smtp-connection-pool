...
import com.swisscom.hyperion.utilities.smtp.transport.strategy.ConnectionStrategy;
import com.swisscom.hyperion.utilities.smtp.transport.strategy.TransportStrategy;
 ...
 * otherwise with the {@link TransportStrategyFactory#newSessionStrategy()} ()}<br>
 */
public class SmtpConnectionFactoryBuilder {
    ...
    public SmtpConnectionFactory build() {
        ...
        TransportStrategy transportStrategy = protocol == null ? TransportStrategyFactory.newSessionStrategy() : TransportStrategyFactory.newProtocolStrategy(protocol);
